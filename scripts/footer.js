let footerContent =
  `<footer style='display: flex;flex-direction: row;justify-content: center;align-items: center;width: 100%;height: fit-content;'>` +
    `<div class="links" style='display: flex;flex-direction: column;width: 50%;'>` +
      `<a href="https://sevent33n-music.github.io/About-Me/" class="temp-link">About</a>` + 
